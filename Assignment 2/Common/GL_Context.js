...
var texture_filenames_to_load = [ "star.png", "text.png", "earth.gif", 
								  "textures/bedrock.jpg", "textures/sky.jpg", "textures/grass2.jpg", "textures/wood.jpg",
								  "textures/c_hair.png", "textures/stone_brick.jpg", "textures/wood_plank.jpg", "textures/leaves.jpg",
								  "textures/clay.jpg", "textures/clay_pot.jpg", "textures/cactus.png", "textures/cactus2.png",
								  "textures/sleeves.jpg", "textures/shirt.jpg", "textures/legs.jpg", "textures/face.jpg", "textures/start_screen.jpg",
								  "textures/stone.jpg", "textures/dirt.jpg", "textures/window.png"];
...
{	this.string_map = { };	this.m_text = new text_line( 20 ); 		this.start_index = 2;	this.tick = 0;
	...
	Debug_Screen.prototype.display = function(time)
	{
			...
			for( var i = 0, idx = this.start_index; i < 1 && i < strings.length; i++, idx = (idx + 1) % strings.length )
			{
